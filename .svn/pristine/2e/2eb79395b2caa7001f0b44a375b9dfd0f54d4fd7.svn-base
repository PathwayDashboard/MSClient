...
import ms.client.model.GuidedWorkoutCircuitSegment;
 ...
 **/
@ApiModel(description = "Guided Workout Exercise specific data for a Guided  Exercise activity")
...
public enum ActivityTypeEnum {
  ...
  private List<GuidedWorkoutCircuitSegment> activitySegments = new ArrayList<GuidedWorkoutCircuitSegment>();
  private Integer roundsPerformed = null;
  private Integer repetitionsPerformed = null;
  private String workoutPlanId = null;
  ...
  public List<GuidedWorkoutCircuitSegment> getActivitySegments() {
    return activitySegments;
  }
  public void setActivitySegments(List<GuidedWorkoutCircuitSegment> activitySegments) {
   ...
   **/
  @ApiModelProperty(value = "A round is the repetition of a circuit of exercises. RoundsPerformed counts the number of complete circuit rounds actually performed. Partial circuits are not counted")
  @JsonProperty("roundsPerformed")
  public Integer getRoundsPerformed() {
    return roundsPerformed;
  }
  public void setRoundsPerformed(Integer roundsPerformed) {
    this.roundsPerformed = roundsPerformed;
  }
   ...
   **/
  @ApiModelProperty(value = "The number of exercise repetitions actually performed")
  @JsonProperty("repetitionsPerformed")
  public Integer getRepetitionsPerformed() {
    return repetitionsPerformed;
  }
  public void setRepetitionsPerformed(Integer repetitionsPerformed) {
   ...
   **/
  @ApiModelProperty(value = "The identifier of the workout plan")
  ...
  public String toString()  {
    ...
    sb.append("class GuidedWorkoutActivity {\n");
    ...
    sb.append("    roundsPerformed: ").append(StringUtil.toIndentedString(roundsPerformed)).append("\n");
    sb.append("    repetitionsPerformed: ").append(StringUtil.toIndentedString(repetitionsPerformed)).append("\n");
    sb.append("    workoutPlanId: ").append(StringUtil.toIndentedString(workoutPlanId)).append("\n");
