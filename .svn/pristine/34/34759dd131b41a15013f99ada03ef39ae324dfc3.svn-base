 ...
 **/
@ApiModel(description = "Guided Workout Circuit Segment record for a Guided Workout")
...
public class GuidedWorkoutCircuitSegment   {
  ...
  private Integer circuitOrdinal = null;
  private Integer circuitType = null;
...
public enum SegmentTypeEnum {
   ...
   **/
  @ApiModelProperty(value = "The ordinal of the circuit within the workout")
  @JsonProperty("circuitOrdinal")
  public Integer getCircuitOrdinal() {
    return circuitOrdinal;
  }
  public void setCircuitOrdinal(Integer circuitOrdinal) {
    this.circuitOrdinal = circuitOrdinal;
  }
   ...
   **/
  @ApiModelProperty(value = "The type of the circuit")
  @JsonProperty("circuitType")
  public Integer getCircuitType() {
    return circuitType;
  }
  public void setCircuitType(Integer circuitType) {
  ...
  public String toString()  {
    ...
    sb.append("class GuidedWorkoutCircuitSegment {\n");
    
    sb.append("    circuitOrdinal: ").append(StringUtil.toIndentedString(circuitOrdinal)).append("\n");
    sb.append("    circuitType: ").append(StringUtil.toIndentedString(circuitType)).append("\n");
