...
import ms.client.auth.ApiKeyAuth;
import ms.client.auth.Authentication;
import ms.client.auth.HttpBasicAuth;
...
public class ApiClient {
  ...
  private String basePath = "https://api.microsofthealth.net";
