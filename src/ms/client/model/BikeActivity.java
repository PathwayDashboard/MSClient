...
import ms.client.model.BikeSegment;
 ...
 **/
@ApiModel(description = "Bike specific data for a biking activity")
...
public class BikeActivity {
	...
	public enum ActivityTypeEnum {
		UNKNOWN("Unknown"), CUSTOM("Custom"), CUSTOMEXERCISE("CustomExercise"), CUSTOMCOMPOSITE("CustomComposite"), RUN(
				"Run"), SLEEP("Sleep"), FREEPLAY("FreePlay"), GUIDEDWORKOUT("GuidedWorkout"), BIKE("Bike"), GOLF(
						"Golf"), REGULAREXERCISE("RegularExercise");
	...
	private List<BikeSegment> activitySegments = new ArrayList<BikeSegment>();
	...
	public List<BikeSegment> getActivitySegments() {
		return activitySegments;
	}

	public void setActivitySegments(List<BikeSegment> activitySegments) {
	...
	/**
	 * The ISO 8601 formatted length of time the user was paused during the
	 * activity
	 **/
	...
	/**
	 * The mapping of an event to a logical date. For most events, other than
	 * sleep, \n the default assignment is based on the event's start time. This
	 * is subject to change \n in the future. For example, if a sleep activity
	 * starts before 5 AM, the DayId is the previous day.
	 **/
	...
	public String toString() {
		...
		sb.append("    caloriesBurnedSummary: ").append(StringUtil.toIndentedString(caloriesBurnedSummary))
				.append("\n");
