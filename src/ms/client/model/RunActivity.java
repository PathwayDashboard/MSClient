...
import ms.client.model.RunSegment;
 ...
 **/
@ApiModel(description = "Run specific data for a Run activity")
...
public enum ActivityTypeEnum {
  ...
  private List<RunSegment> activitySegments = new ArrayList<RunSegment>();
  ...
  public List<RunSegment> getActivitySegments() {
    return activitySegments;
  }
  public void setActivitySegments(List<RunSegment> activitySegments) {
